...
var script = {
  ...
  computed: {
    ...
    phoneObject: function phoneObject() {
      ...
      if (result.regionCode && this.onlyCountries && this.onlyCountries.length && !this.onlyCountries.includes(result.regionCode)) {
        result.valid = false;
